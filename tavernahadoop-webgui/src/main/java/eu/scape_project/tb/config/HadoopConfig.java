...
public class HadoopConfig {
    ...
    private static Logger logger = LoggerFactory.getLogger(HadoopConfig.class.getName());
    private Properties properties;
    private HashMap<String, String> map;
    
    public static final String TAVERNA_PROPERTIES = "/hadoop.properties";
    ...
    public HadoopConfig() {
        try {
            ...
            properties.load(HadoopConfig.class.getResourceAsStream(TAVERNA_PROPERTIES));
