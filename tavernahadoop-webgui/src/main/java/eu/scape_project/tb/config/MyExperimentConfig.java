 ...
 * @version 0.1
 */
public class MyExperimentConfig {

    private static Logger logger = LoggerFactory.getLogger(MyExperimentConfig.class.getName());
    private Properties properties;
    private HashMap<String, String> map;
    
    public static final String MYEXPERIMENT_PROPERTIES = "/myexperiment.properties";
     ...
     */
    public MyExperimentConfig() {
        try {
            properties = new Properties();
            
            properties.load(MyExperimentConfig.class.getResourceAsStream(MYEXPERIMENT_PROPERTIES));
            logger.debug("Property file \"" + MYEXPERIMENT_PROPERTIES + "\" loaded.");
